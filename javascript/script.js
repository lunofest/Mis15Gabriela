...
function updateTimer() {
  const targetDate = new Date("january 18, 2025 21:30:00").getTime();
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const phoneNumber1 = '541140427970'; // Número para el primer botón
...
document.addEventListener('DOMContentLoaded', function() {
  // Definir los números de teléfono
  const recipientNumber1 = '541140427970'; // Número para el primer botón
